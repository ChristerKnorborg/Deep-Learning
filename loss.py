...
class YOLOLoss(nn.Module):
    ...
    def forward(self, predictions: torch.Tensor, target: torch.Tensor):
        ...
        # Tensor have shape (batch_size, S, S, 5*B) where 5*B is from the formula (P_c, x, y, w, h), where P_c is the probability of the person object
        # being present in bouding box B, where every bounding box has 5 values (P_c, x, y, w, h). x and y are the coordinates of the center of the object
        # relative to the grid cell, w and h are the width and height of the bounding box relative to the whole image.


        # Bounding box coordinates
        pred_boxes = predictions[..., 0:5*B].reshape(-1, S, S, B, 5) # 2 bounding boxes in predictions
        target_boxes = target[..., 0:5].reshape(-1, S, S, 1, 5) # 1 bounding box in target


        # Separate the probability of a person being presentfor each bounding box. E.g. make a tensor of shape (batch_size, S, S, 1),
        # where each entry 1 is the probability of the object being present in bouding box B
        pred_confidence1 = predictions[..., 0:1] # Extract index 0 from the last dimension of the tensor (P_c from bounding box 1)
        pred_confidence2 = predictions[..., 5:6] # Extract index 5 from the last dimension of the tensor (P_c from bounding box 2)
        target_confidence = target[..., 0:1] # Extract index 1 (P_c) from the last dimension of the tensor-
...
#         [[ 5.0000, 0.6825, 0.5000, 0.1950, 1.0000, 1.0000, 2.0000, 1.0000, 1.0000, 1.0000],
#          [ 0.0000, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000],
#          [ 0.0000, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000],
#          [ 5.0000, 0.5000, 0.7434, 1.0000, 0.9305, 1.0000, 2.0000, 1.0000, 1.0000, 1.0000],
#          [ 0.0000, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000],
#          [ 0.0000, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000],
#          [ 0.0000, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000]],
...
#          [ 0.0000, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000],
#          [ 0.0000, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000],
#          [ 5.0000, 0.5000, 0.7434, 1.0000, 0.9305, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000],
#          [ 0.0000, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000],
#          [ 0.0000, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000],
#          [ 0.0000, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000]],
...
#         [[ 0.0000, 0.0000, 0.0000, 0.0000, 0.0000],
#          [ 0.0000, 0.0000, 0.0000, 0.0000, 0.0000],
#          [ 3.0000, 0.0223, 0.5000, 0.5778, 1.0000],
#          [ 4.0000, 0.5000, 0.5000, 1.0000, 1.0000],
#          [ 0.0000, 0.0000, 0.0000, 0.0000, 0.0000],
#          [ 0.0000, 0.0000, 0.0000, 0.0000, 0.0000],
#          [ 0.0000, 0.0000, 0.0000, 0.0000, 0.0000]],
